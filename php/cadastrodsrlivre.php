...
$id = mysql_connect('mysql.hostinger.com.br',$usuario,$password);
      ...
      <?php
         ...
         $sql ="INSERT INTO tb_discipuladores(dsr_nome,dsr_sex_codigo,dsr_civ_codigo,dsr_bai_codigo,dsr_pgm_codigo, dsr_std_codigo,dsr_dta_cadastro) VALUES ('$nome','$tiposexo','$est_civil','$bairro','$spgm','2',current_timestamp)"; 
