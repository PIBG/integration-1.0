...
$sql ="INSERT INTO tb_novos(nvo_nome,nvo_dta_nascimento,nvo_sex_codigo,nvo_dta_decisao,nvo_civ_codigo,nvo_logradouro,nvo_bai_codigo,nvo_dec_codigo) VALUES ('$nome','$dtanascimento','$tiposexo','$dtaconversao','$est_civil','$logradouro','$bairro','$decisao')"; 
...
if (isset($email)) {
	$sql5 =mysql_query("INSERT INTO tb_email_novos(email_novos,email_nvo_codigo) VALUES ('$email','$ultimo_id')") ;
}
if (isset($numero)) {
	$sql3 =mysql_query("INSERT INTO tb_tel_novos(tel_novos,tel_nvo_codigo) VALUES ('$numero','$ultimo_id')") ; 
}
...
if ($tursegunda==1 or $tursegunda==2 or $tursegunda==3 or $tursegunda==4)  {
  $segunda = mysql_query("INSERT INTO tb_disp_novos (dsp_dia_codigo, dsp_tur_codigo, dsp_nvo_codigo) VALUES ('1','$tursegunda','$ultimo_id')");
}

if($turterca==1 or $$turterca==2 or $turterca==3 or $turterca==4){
$terca = mysql_query("INSERT INTO tb_disp_novos (dsp_dia_codigo, dsp_tur_codigo, dsp_nvo_codigo) VALUES ('2','$turterca','$ultimo_id')");
}
if($turquarta==1 or $turquarta==2 or $turquarta==3 or $turquarta==4) {
$quarta = mysql_query("INSERT INTO tb_disp_novos (dsp_dia_codigo, dsp_tur_codigo, dsp_nvo_codigo) VALUES ('3','$turquarta','$ultimo_id')");
}
if($turquinta==1 or $turquinta==2 or $turquinta==3 or $turquinta==4){
$quinta = mysql_query("INSERT INTO tb_disp_novos (dsp_dia_codigo, dsp_tur_codigo, dsp_nvo_codigo) VALUES ('4','$turquinta','$ultimo_id')");
}
if($tursexta==1 or $tursexta==2 or $tursexta==3 or $tursexta==4) {
$sexta = mysql_query("INSERT INTO tb_disp_novos (dsp_dia_codigo, dsp_tur_codigo, dsp_nvo_codigo) VALUES('5','$tursexta','$ultimo_id')");
}
if($tursabado==1 or $tursabado==2 or $tursabado==3 or $tursabado==4) {
$sabado = mysql_query("INSERT INTO tb_disp_novos (dsp_dia_codigo, dsp_tur_codigo, dsp_nvo_codigo) VALUES ('6','$tursabado','$ultimo_id')");
}
if($turdomingo==1 or $turdomingo==2 or $turdomingo==3 or $turdomingo==4) {
$domingo = mysql_query("INSERT INTO tb_disp_novos (dsp_dia_codigo, dsp_tur_codigo, dsp_nvo_codigo) VALUES ('7','$turdomingo','$ultimo_id')");
}      
